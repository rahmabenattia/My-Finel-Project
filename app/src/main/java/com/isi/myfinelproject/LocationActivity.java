...
public class LocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btFind = findViewById(R.id.find_button);
        ...
        String[] placeNameList ={"Hospital","Health Center"};
        sp_type.setAdapter(new ArrayAdapter<>(LocationActivity.this , android.R.layout.simple_spinner_dropdown_item,placeNameList));
        ...
        if (ActivityCompat.checkSelfPermission(LocationActivity.this
            ...
            Log.d(TAG, "onCreate: Permission Failed, Requesting Permission");
        ...
        btFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String categorie =  sp_type.getSelectedItem().toString();
    ...
    private class ParserTask extends  AsyncTask<String,Integer, List<HashMap<String,String>>> {
        ...
        protected void onPostExecute(List<HashMap<String, String>> hashMaps) {
            ...
            myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(camlatlng, NEARBY_ZOOM));
